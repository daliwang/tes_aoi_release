...
KILOCRAFT_ROOT="${CLI185PROJ_ROOT}/proj-shared/wangd/kiloCraft/"
...
# Transient case directory (Phase 1: 1850 start, 150 years)
CASEDIR="$KMELM_CASE_ROOT/${TES_DOMAIN_FORCING_GROUP_ID}/uELM_${EXPID}_${CASE_COMPSET}_transient1"
...
# Scientific configuration for transient Phase 1 (1850 start, 150 years)
...
finidat = '${KMELM_RUN_ROOT}/uELM_${EXPID}_I1850CNPRDCTCBC_finalspin/run/uELM_${EXPID}_I1850CNPRDCTCBC_finalspin.elm.r.0801-01-01-00000.nc'
